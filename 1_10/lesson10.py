...
s = 'Helloworld'
# print(len(s)) - кол-во символов
# s2 = s.capitalize() - вверхний регистр символа (с большой)
# print(s, s2)
# print(s.center(20, '!')) - в центр '' - символ заполнителя
# print(s.count('l', 0, 4)) - кол-во сомвола (диапозон)
# print(s.find('a'))
# print(s.index('o'))
# print(s.replace('l', 't')) - заменитель
